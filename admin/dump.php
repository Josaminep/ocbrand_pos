...
$sql = "SELECT id, brand, name, category, price, quantity, image FROM products";
  ...
  <div class="pos-grid">
    ...
    <div class="totals">
      ...
      <div class="checkout-actions">
        ...
        <button class="btn-primary" id="checkoutBtn"><i class="fas fa-cash-register"></i> Checkout</button>
      </div>
    </div>
...
/* Customer modal */
document.getElementById('cancelCust').addEventListener('click',()=>{ document.getElementById('customerModal').style.display='none'; });
...
function computeChange(){
  ...
  let change=cash-grandTotalValue;
