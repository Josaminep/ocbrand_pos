...
$sql = "SELECT product_code, created_at, brand, name, category, srp, price, quantity FROM products WHERE 1";
...
<tr>
    <td colspan="6" style="font-weight:bold;text-align:right;">TOTAL STOCK</td>
